...
class GscraperSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in range(1,total_page_no):
            ...
            yield scrapy.Request(url=url, callback=self.parse_ratings, meta={'proxy': 'http://scraperapi:ef5ce54b6e77c240354ac4f5efdd3cc1@proxy-server.scraperapi.com:8001'}, dont_filter=dont_filter,)
    ...
    def parse_ratings(self, response):
        ...
        for i in range (0,len(reviews)):
            ...
            review['company_name'] = "BANK OF NEW YORK MELLON CORP"
            review['symbol'] = "BK"
            review['name_glassdoor'] = "BANK OF NEW YORK MELLON CORP"
            review['total_reviews'] = "8000"
